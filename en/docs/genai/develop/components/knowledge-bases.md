...
description: Reference for every Knowledge Base in WSO2 Integrator BI — Vector Knowledge Base and Azure AI Search Knowledge Base — covering init form fields, advanced configurations, and the ingest, retrieve, and delete actions.
---
