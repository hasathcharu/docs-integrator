...
- [Prometheus](prometheus-metrics.md) -- Set up self-managed metrics collection
- [Grafana](grafana-dashboards.md) -- Build custom dashboards for on-premise deployments
- [Jaeger](jaeger-distributed-tracing.md) -- Self-managed distributed tracing
