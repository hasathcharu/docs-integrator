...
| Tool | Category | Page |
|------|----------|------|
| WSO2 Devant | Full-stack observability | [Devant](observability-overview.md) |
| Prometheus | Metrics collection | [Prometheus](prometheus-grafana.md) |
| Grafana | Metrics visualization | [Grafana](prometheus-grafana.md) |
| Jaeger | Distributed tracing | [Jaeger](jaeger-zipkin-tracing.md) |
| Zipkin | Distributed tracing | [Zipkin](jaeger-zipkin-tracing.md) |
...
- [Prometheus](prometheus-grafana.md) -- Set up metrics collection
- [Grafana](prometheus-grafana.md) -- Visualize metrics with dashboards
- [Jaeger](jaeger-zipkin-tracing.md) -- Enable distributed tracing
