...
- [Scaling & High Availability](../scaling-high-availability.md) -- Configure horizontal scaling
- [GraalVM Native Images](../graalvm-native-images.md) -- Reduce resource requirements with native compilation
