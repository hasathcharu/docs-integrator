...
- [Scaling & High Availability](../scaling-high-availability.md) -- Scale based on throughput requirements
- [GraalVM Native Images](../graalvm-native-images.md) -- Build native images for lower resource usage
