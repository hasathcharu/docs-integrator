...
WSO2 Cloud includes a browser-based editor where you can create and develop integrations without installing anything locally. Once your integration is ready, you deploy it to WSO2 Cloud directly from the editor.
...
3. Select the Git provider, then the organization, and then the repository where the integration will be saved.

   If you don't have an empty repository ready, click **Create New Repository** to create one on GitHub.
