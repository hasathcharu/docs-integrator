...
FTP, SFTP, and FTPS [file integrations](/docs/get-started/concepts/core-concepts#file-integrations) poll remote file servers for new files and process them as they arrive. Use them for ETL pipelines, batch processing, and B2B integrations where partners exchange data as CSV, XML, JSON, or binary files.
...
For the general concept, see [Services and listeners](/docs/get-started/concepts/core-concepts#services-and-listeners). For the language-level details, see [Integration-specific features](../../../reference/language/integration-specific-features.md).
