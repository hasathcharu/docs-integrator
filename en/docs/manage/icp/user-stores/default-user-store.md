...
description: Configure the ICP built-in credentials database — connect an external PostgreSQL, MySQL, or MSSQL database and tune password hashing, account lockout, and secrets.
---
