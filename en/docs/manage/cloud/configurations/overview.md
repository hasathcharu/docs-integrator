...
The value is encrypted and stored in the secret vault. Once saved, the value cannot be viewed. You can only replace it with a new value by clicking the padlock icon again and entering the updated secret.
...
2. Click **Edit Configuration Group**.
3. Update the fields, their types, and their values as needed.
...
Once you have a configuration group, you can link its fields to the configurables in an integration instead of setting values individually.
