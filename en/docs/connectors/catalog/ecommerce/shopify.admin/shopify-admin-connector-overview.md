...
* **[Example](example.md)**: Learn how to build and configure an integration using the **Shopify Admin** connector, including connection setup, operation configuration, and execution flow.
