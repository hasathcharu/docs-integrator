  ...
  mainSidebar: [
    ...
    // ─────────────────────────────────────────────
    {
      ...
      items: [
        ...
        'deploy/run-locally',
        'deploy/vm-based-deployment',
        'deploy/docker-kubernetes',
        'deploy/red-hat-openshift',
        'deploy/serverless-deployment',
        'deploy/aws-azure-gcp',
        'deploy/graalvm-native-images',
        'deploy/environments',
        'deploy/managing-configurations',
        'deploy/scaling-high-availability',
        // CI/CD
        {
          type: 'category',
          label: 'CI/CD',
        ...
        // Observe
        {
          ...
          label: 'Observe',
          items: [
            'deploy/observe/observability-overview',
            'deploy/observe/logging-structured-logs',
            'deploy/observe/custom-metrics',
            'deploy/observe/prometheus-grafana',
            'deploy/observe/jaeger-zipkin-tracing',
            'deploy/observe/datadog-integration',
            'deploy/observe/new-relic-integration',
            'deploy/observe/elastic-stack-elk',
            'deploy/observe/opensearch-integration',
            'deploy/observe/moesif-api-analytics',
          ],
        },
        // Secure
        {
          ...
          label: 'Secure',
          items: [
            'deploy/secure/runtime-security',
            'deploy/secure/authentication',
            'deploy/secure/api-security-rate-limiting',
            'deploy/secure/secrets-encryption',
            'deploy/secure/compliance-considerations',
          ],
        },
        // Capacity Planning
        {
          ...
          link: { type: 'doc', id: 'deploy/capacity-planning/capacity-planning' },
          items: [
            'deploy/capacity-planning/performance-reports',
          ],
        },
      ],
    },
